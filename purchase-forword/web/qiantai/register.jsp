	...
	<script>
		$(function () {
		    $("#username").blur(function () {
				...
				$.get("${pageContext.request.contextPath}/user?username="+uName+"&type=checkUser",function (data,status) {
				    if (data=='true') {
				        $("#notice").text("用户名重复！");
					}
                })
...
<div class="usBox">
	<div class="usBox_2 clearfix">
		...
		<form action="../user" method="post" name="formUser" onsubmit="checkForm()" >
