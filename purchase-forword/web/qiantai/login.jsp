...
<script>
    function change() {
        ...
        img.src = "${pageContext.request.contextPath}/user?type=getValidate&a=" + new Date();
        // alert("${pageContext.request.contextPath}/user?type=login");
    }
</script>
<body>
<!--LOGO欢迎信息和登陆注册功能-->
...
<div class="usBox clearfix">
    <div class="usBox_1 f_l">
        ...
        <form name="formLogin" action="../user" method="post">
            ...
            <table width="100%" border="0" align="left" cellpadding="3" cellspacing="5">
                ...
                <tr>
                    ...
                    <td><input name="verification" type="text" size="8"/><img id="img1" src="../user?type=getValidate"
                                                                              style="width: 90px;height: 20px;position: relative;top:5px"><a
                            href="javascript:change()">换一张</a>&nbsp;&nbsp; <span style="color:#FF0000"> ${info}</span>
                    </td>
